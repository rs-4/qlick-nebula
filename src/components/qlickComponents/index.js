...
const Container = styled.div`
  ...
  ${props => props.objectType === 'kpi' && css`
    width: 300px;
    height: 100px;
    min-width:100px;
  ...
  ${props => props.objectType === 'piechart' && css`
    width: 600px;
    height: 500px;  min-width:300px;
  `}

  ${props => props.objectType === 'barchart' && props.size === 'normal' && css`
    width: 800px;
    height: 500px;   
    min-width:300px;
  `}
  ${props => props.objectType === 'barchart' && props.size === 'xl' && css`
     height: 85vh;
     border: none;  

  `} 
  ${props => props.objectType === 'linechart' && props.size === 'xl' && css`
     height:85vh;
     border: none;  

  `}
  ${props => props.objectType === 'table' && props.size === 'xl' && css`
    border: none;
    height: 85vh;  
    min-width:300px;
  `}
